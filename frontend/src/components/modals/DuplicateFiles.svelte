...
<div
    ...
    class:hidden={!$duplicateFiles}
    class="hidden overflow-y-auto overflow-x-hidden fixed top-[1.6rem] right-0 left-0 z-40 justify-center items-center w-full md:inset-0 h-[80%] max-h-full rounded-2xl"
>
    <div class="relative pt-0 px-1 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            >
                ...
                <button
                    class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-10 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                >
                    Refresh
                </button>
            </div>
