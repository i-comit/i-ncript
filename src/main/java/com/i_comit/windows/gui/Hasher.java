...
import com.i_comit.windows.gui.Statics;
...
public class Hasher {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Str length a " + modHash(a) + "\n");
        System.out.println("Str pad" + numPadder(modHash(a)));
    ...
    public static String modHash(String password) {
        ...
        switch (length) {
            case 7 -> {
                hashTrimmer = pw / 1000;
                System.out.println("Hash Trimmed " + hashTrimmer);
                //Trims to 4 digits
                ...
                System.out.println("Hash Final " + sb.toString());
